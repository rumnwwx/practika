# Generated by Django 3.2.25 on 2024-11-09 04:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите название издания (например, Penguin Classics, Альфа-книга)', max_length=200, unique=True)),
                ('publication_city', models.CharField(help_text='Введите город выпуска издания (например, Москва, Нью-Йорк)', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
